...
run MCRInstaller to install version 7.14.1 of MCR. For more 
    ...
    Windows                 PATH
     ...
     ii. Set the path by doing one of the following:
        ...
        a command prompt and issuing the DOS command:
            ...
            set PATH=<mcr_root>\v7141\runtime\win32;%PATH% 

        Alternately, for Windows, add the following pathname:
            <mcr_root>\v7141\runtime\win32
