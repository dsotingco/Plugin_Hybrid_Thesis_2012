...
save('SERIES_CO2_CS_HWFET','SERIES_CO2_CS_HWFET');
save('SERIES_CO2_CS_US06','SERIES_CO2_CS_US06');

save('SERIES_ELEC_CD_FTP','SERIES_ELEC_CD_FTP');
save('SERIES_ELEC_CD_HWFET','SERIES_ELEC_CD_HWFET');
save('SERIES_ELEC_CD_US06','SERIES_ELEC_CD_US06');

save('SERIES_CDRANGE','SERIES_CDRANGE');
